...
%%%% TOP-DOWN
%% PROS
%+ can be used to introduce a method for horizontal scaling 
%+ can easily be adopted by users as it does not change the core code of the cloud platform that is already trusted by the users
%+ if done properly, can potentially allow users to be exposed to the API endpoints they are already used to. I.e., they do not need to use new client libraries or a new 'horizon' for accessing the services. 

%% CONS
%+ It may not be possible to implement some as efficiently as if they were done bottom-up
...
%% CONS
%- How can you address the multi operator use-case? 
%- look at the pros above and identify the related cons
