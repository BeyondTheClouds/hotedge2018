...
resources), we have defined two sub-levels,
% as depicted in \cref{tab:requirements},
respectively called L2.1 and L2.2. The implicit
...
management services, we refined L3 into two sub-classes. L3.1 is
...
%
Such a requirement implies to be able to get sites' capabilities in order to
